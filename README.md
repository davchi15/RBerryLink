...
The video uses the Geekworm X1202, however, the RBerryLink is compatible with multiple models.
---
...
|-------|---------------------------------|---------|
| 30 - 60 | `60 seconds ~ 2 minutes` | `Default — best accuracy on start` |
| 15 - 30 | `30 seconds ~ 1 minute` | `Good balance` |
| 5 - 10  | `10 ~ 20 seconds` | `Fast but less accurate on first launch` | 
| 0.5 - 1 | `1 ~ 2 seconds` | `Skip splash entirely (testing only)` |   
